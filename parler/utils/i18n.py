...
def is_supported_django_language(language_code):
    ...
    """
    language_code2 = language_code.split('-')[0] # e.g. if fr-ca is not supported fallback to fr or fr-fr
    return language_code in LANGUAGES_DICT or language_code2 in LANGUAGES_DICT or language_code2 in [l.split('-')[0] for l in LANGUAGES_DICT]
